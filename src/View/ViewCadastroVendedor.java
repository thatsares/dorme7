...
public class ViewCadastroVendedor extends javax.swing.JFrame {
    ...
    private void cadastraVendedor(Vendedor novoVendedor)throws NoSuchAlgorithmException,
         UnsupportedEncodingException{
        this.conectar.conectaBanco(); 
        
        novoVendedor.setNome(txtNome.getText());
        novoVendedor.setCnpj(txtCpf.getText());
        novoVendedor.setSenha(campoSenha.getText());
        novoVendedor.setSexo((String) txtSexo.getSelectedItem());
        novoVendedor.setEndereco(txtEndereco.getText());
        novoVendedor.setCidade(txtCidade.getText());
        novoVendedor.setEstado((String) txtEstado.getSelectedItem());
        novoVendedor.setIdade(txtIdade.getText());
        
        try {
                        
            this.conectar.insertSQL("INSERT INTO vendedores ("
                    + "vendedor_nome,"                    
                    + "vendedor_cnpj,"
                    + "vendedor_senha,"
                    + "vendedor_sexo,"
                ...
                + ") VALUES ("
                    ...
                    + "'" + novoVendedor.getCnpj()        + "',"
                    + "'" + novoVendedor.getSenha()      + "',"
                    + "'" + novoVendedor.getSexo()       + "',"
                    + "'" + novoVendedor.getEndereco()   + "',"
                    + "'" + novoVendedor.getCidade()     + "',"
                    + "'" + novoVendedor.getEstado()     + "',"
                    + "'" + novoVendedor.getIdade()      + "'"
                    + ");");
            ...
            JOptionPane.showMessageDialog(null, "Cendedor cadastrado com sucesso");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro de Anunciantes"));
        jPanel1.setName("Cadastro de Anunciantes"); // NOI18N
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Cadastro de Anunciantes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCadastroVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
